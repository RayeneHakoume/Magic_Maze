...
void PadPlateau::miseAJour(){
  unsigned int i,j;
    
  unsigned int taille1 = pl.tab_tuile.size();
  for(i=0; i< taille1 ; i++){
    for(j=0; j< MAX_NB_CASES ; j++){

      switch(pl.tab_tuile[i].gettabCasePossedeObjet(j)){
        case 0:
          break;
        //BOUTIQUE = 10
        case 10 :
          ajouter_boutique(emplacement[2*i],emplacement[2*i+1],Case(j) ) ;
          break;
        //DEPART = 20
        case 21:
          placer_joueur(emplacement[2*i],emplacement[2*i+1],Case(j),Couleur::JAUNE) ;
          break;
        case 22:
          placer_joueur(emplacement[2*i],emplacement[2*i+1],Case(j),Couleur::VERT) ;
          break;
        case 23:
          placer_joueur(emplacement[2*i],emplacement[2*i+1],Case(j),Couleur::VIOLET) ;
          break;
        case 24:
          placer_joueur(emplacement[2*i],emplacement[2*i+1],Case(j),Couleur::ORANGE) ;
          break;
        //PORTE = 30
        case 30:
          ajouter_porte(emplacement[2*i],emplacement[2*i+1],Case(j), Couleur::AUCUNE) ;
          break;
        case 31:
          ajouter_porte(emplacement[2*i],emplacement[2*i+1],Case(j),Couleur::JAUNE) ;
          break;
        case 32:
          ajouter_porte(emplacement[2*i],emplacement[2*i+1],Case(j),Couleur::VERT) ;
          break;
        case 33:
          ajouter_porte(emplacement[2*i],emplacement[2*i+1],Case(j),Couleur::VIOLET) ;
          break;
        case 34:
          ajouter_porte(emplacement[2*i],emplacement[2*i+1],Case(j),Couleur::ORANGE) ;
          break;
        //OBJECTIF = 40
        case 41:
          ajouter_objectif(emplacement[2*i],emplacement[2*i+1],Case(j),Couleur::JAUNE) ;
          break;
        case 42:
          ajouter_objectif(emplacement[2*i],emplacement[2*i+1],Case(j),Couleur::VERT) ;
          break;
        case 43:
          ajouter_objectif(emplacement[2*i],emplacement[2*i+1],Case(j),Couleur::VIOLET) ;
          break;
        case 44:
          ajouter_objectif(emplacement[2*i],emplacement[2*i+1],Case(j),Couleur::ORANGE) ;
          break;  
        //SORTIE = 50
        case 51:
          ajouter_sortie(m_tuiles[2*i],m_tuiles[2*i+1],Case(j),Couleur::JAUNE) ;
          break;
        case 52:
          ajouter_sortie(m_tuiles[2*i],m_tuiles[2*i+1],Case(j),Couleur::VERT) ;
          break;
        case 53:
          ajouter_sortie(m_tuiles[2*i],m_tuiles[2*i+1],Case(j),Couleur::VIOLET) ;
          break;
        case 54:
          ajouter_sortie(m_tuiles[2*i],m_tuiles[2*i+1],Case(j),Couleur::ORANGE) ;
          break; 
        //VORTEX = 60
        case 61:
          ajouter_vortex(m_tuiles[2*i],m_tuiles[2*i+1],Case(j),Couleur::JAUNE) ;
          break;
        case 62:
          ajouter_vortex(m_tuiles[2*i],m_tuiles[2*i+1],Case(j),Couleur::VERT) ;
          break;
          case 63:
            ajouter_vortex(m_tuiles[2*i],m_tuiles[2*i+1],Case(j),Couleur::VIOLET) ;
          break;
        case 64:
          ajouter_vortex(m_tuiles[2*i],m_tuiles[2*i+1],Case(j),Couleur::ORANGE) ;
          break;    
        default:
          cout<<"La case "<<j<<"possede un numero inconnu : "<<pl.tab_tuile[i].gettabCasePossedeObjet(j)<<endl;
          break;
        }      
    ...
    for(i=0; i< taille1 ; i++){
      for(j=0; j< MAX_NB_MURS ; j++){
        if(pl.tab_tuile[i].getTabMurs(j)){
            MMaze::Mur m(j);
            ajouter_mur(m_tuiles[2*i],m_tuiles[2*i+1],Mur(j)) ;        
        }
       }
    } 
  }
